...
| `zoom.panStabilizationThreshold` | `number` | `0` (off) | Keep the camera still between nearby zoom targets, see [Stabilizing the pan](/docs/guides/zoom-and-focus#stabilizing-the-pan) |
